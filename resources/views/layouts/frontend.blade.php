                    ...
                    <div class="header__main ul_li_between">
                        <div class="header__left ul_li">
                            <div class="header__logo">
                                <a href="index.html"><img src="{{asset('frontend/assets/img/logo/logo.svg')}}" alt=""></a>
                            </div>
                ...
                <div class="template__slider swiper-container">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide template__item">
                            ...
                            <div class="image">
                                <img src="{{asset('frontend/assets/img/template/img_01.png')}}" alt="">
                            </div>
                        </div>
                        <div class="swiper-slide template__item">
                            ...
                            <a href="#!"><i class="far fa-arrow-right"></i>More Details</a>
                            <div class="image">
                                <img src="{{asset('frontend/assets/img/template/img_02.png')}}" alt="">
                            </div>
                        </div>
                        <div class="swiper-slide template__item">
                            ...
                            <a href="#!"><i class="far fa-arrow-right"></i>More Details</a>
                            <div class="image">
                                <img src="{{asset('frontend/assets/img/template/img_03.png')}}" alt="">
                            </div>
                        </div>
                        <div class="swiper-slide template__item">
                            ...
                            <a href="#!"><i class="far fa-arrow-right"></i>More Details</a>
                            <div class="image">
                                <img src="{{asset('frontend/assets/img/template/img_04.png')}}" alt="">
                            </div>
                        </div>
                        <div class="swiper-slide template__item">
                            ...
                            <a href="#!"><i class="far fa-arrow-right"></i>More Details</a>
                            <div class="image">
                                <img src="{{asset('frontend/assets/img/template/img_05.png')}}" alt="">
                            </div>
                        </div>
                        <div class="swiper-slide template__item">
                            ...
                            <a href="#!"><i class="far fa-arrow-right"></i>More Details</a>
                            <div class="image">
                                <img src="{{asset('frontend/assets/img/template/img_06.png')}}" alt="">
                            </div>
                        </div>
                        <div class="swiper-slide template__item">
                            ...
                            <a href="#!"><i class="far fa-arrow-right"></i>More Details</a>
                            <div class="image">
                                <img src="{{asset('frontend/assets/img/template/img_07.png')}}" alt="">
                            </div>
                        </div>
                        <div class="swiper-slide template__item">
                            ...
                            <a href="#!"><i class="far fa-arrow-right"></i>More Details</a>
                            <div class="image">
                                <img src="{{asset('frontend/assets/img/template/img_08.png')}}" alt="">
                            </div>
                        </div>
                        <div class="swiper-slide template__item">
                            ...
                            <a href="#!"><i class="far fa-arrow-right"></i>More Details</a>
                            <div class="image">
                                <img src="{{asset('frontend/assets/img/template/img_09.png')}}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <footer class="site-footer dark-bg footer-style-one pos-rel">
                ...
                <div class="row footer__cta-area mt-none-30">
                    ...
                    <div class="col-lg-4 col-md-6 mt-30">
                        <div class="footer__cta pl-45">
                            ...
                            <span class="cta-number"><span><img src="{{asset('frontend/assets/img/icon/np_icon.svg')}}" alt=""></span>760 398-3535</span>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 mt-30">
            ...
            <div class="footer__shape">
                <div class="shape shape--1">
                    <img src="{{asset('frontend/assets/img/shape/f_shape1.png')}}" alt="">
                </div>
